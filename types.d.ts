...
export interface AceEditorProps {
  name?: string;
  /** For available modes see https://github.com/ajaxorg/ace/tree/master/lib/ace/mode */
  mode?: string;
  /** For available themes see https://github.com/ajaxorg/ace/tree/master/lib/ace/theme */
  theme?: string;
  height?: string;
  width?: string;
  className?: string;
