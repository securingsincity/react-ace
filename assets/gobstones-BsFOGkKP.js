import{a0 as F}from"./theme-terminal-ylQyTtHj.js";function r(p,e){for(var n=0;n<e.length;n++){const _=e[n];if(typeof _!="string"&&!Array.isArray(_)){for(const T in _)if(T!=="default"&&!(T in p)){const t=Object.getOwnPropertyDescriptor(_,T);t&&Object.defineProperty(p,T,t.get?t:{enumerable:!0,get:()=>_[T]})}}}return Object.freeze(Object.defineProperty(p,Symbol.toStringTag,{value:"Module"}))}var K={exports:{}},L;function C(){return L||(L=1,function(p,e){ace.define("ace/snippets/gobstones.snippets",["require","exports","module"],function(n,_,T){T.exports=`# scope: gobstones
...
snippet docs (función con parámetros)
	/*
		...
		@TIPO: \${6:...}
	*/
`}),ace.define("ace/snippets/gobstones",["require","exports","module","ace/snippets/gobstones.snippets"],function(n,_,T){_.snippetText=n("./gobstones.snippets"),_.scope="gobstones"}),function(){ace.require(["ace/snippets/gobstones"],function(n){p&&(p.exports=n)})}()}(K)),K.exports}var o=C();const i=F(o),s=r({__proto__:null,default:i},[o]);export{s as g};
