import{a0 as i}from"./theme-terminal-ylQyTtHj.js";function l(r,n){for(var o=0;o<n.length;o++){const e=n[o];if(typeof e!="string"&&!Array.isArray(e)){for(const c in e)if(c!=="default"&&!(c in r)){const a=Object.getOwnPropertyDescriptor(e,c);a&&Object.defineProperty(r,c,a.get?a:{enumerable:!0,get:()=>e[c]})}}}return Object.freeze(Object.defineProperty(r,Symbol.toStringTag,{value:"Module"}))}var d={exports:{}},_;function u(){return _||(_=1,function(r,n){ace.define("ace/theme/cloud_editor_dark-css",["require","exports","module"],function(o,e,c){c.exports=`
