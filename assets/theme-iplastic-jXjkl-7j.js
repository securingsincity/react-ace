import{a0 as l}from"./theme-terminal-ylQyTtHj.js";function s(n,A){for(var a=0;a<A.length;a++){const e=A[a];if(typeof e!="string"&&!Array.isArray(e)){for(const c in e)if(c!=="default"&&!(c in n)){const t=Object.getOwnPropertyDescriptor(e,c);t&&Object.defineProperty(n,c,t.get?t:{enumerable:!0,get:()=>e[c]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}var i={exports:{}},r;function p(){return r||(r=1,function(n,A){ace.define("ace/theme/iplastic-css",["require","exports","module"],function(a,e,c){c.exports=`.ace-iplastic .ace_gutter {
  background: #dddddd;
  color: #666666
}
...
`}),ace.define("ace/theme/iplastic",["require","exports","module","ace/theme/iplastic-css","ace/lib/dom"],function(a,e,c){e.isDark=!1,e.cssClass="ace-iplastic",e.cssText=a("./iplastic-css");var t=a("../lib/dom");t.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/iplastic"],function(a){n&&(n.exports=a)})}()}(i)),i.exports}var o=p();const g=l(o),d=s({__proto__:null,default:g},[o]);export{d as t};
