import{a0 as g}from"./theme-terminal-ylQyTtHj.js";function A(c,o){for(var n=0;n<o.length;n++){const e=o[n];if(typeof e!="string"&&!Array.isArray(e)){for(const a in e)if(a!=="default"&&!(a in c)){const r=Object.getOwnPropertyDescriptor(e,a);r&&Object.defineProperty(c,a,r.get?r:{enumerable:!0,get:()=>e[a]})}}}return Object.freeze(Object.defineProperty(c,Symbol.toStringTag,{value:"Module"}))}var t={exports:{}},l;function m(){return l||(l=1,function(c,o){ace.define("ace/theme/katzenmilch-css",["require","exports","module"],function(n,e,a){a.exports=`.ace-katzenmilch .ace_gutter,
...
`}),ace.define("ace/theme/katzenmilch",["require","exports","module","ace/theme/katzenmilch-css","ace/lib/dom"],function(n,e,a){e.isDark=!1,e.cssClass="ace-katzenmilch",e.cssText=n("./katzenmilch-css");var r=n("../lib/dom");r.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/katzenmilch"],function(n){c&&(c.exports=n)})}()}(t)),t.exports}var i=m();const b=g(i),s=A({__proto__:null,default:b},[i]);export{s as t};
