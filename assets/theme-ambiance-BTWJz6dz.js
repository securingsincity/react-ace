import{a0 as m}from"./theme-terminal-ylQyTtHj.js";function t(c,r){for(var n=0;n<r.length;n++){const a=r[n];if(typeof a!="string"&&!Array.isArray(a)){for(const e in a)if(e!=="default"&&!(e in c)){const o=Object.getOwnPropertyDescriptor(a,e);o&&Object.defineProperty(c,e,o.get?o:{enumerable:!0,get:()=>a[e]})}}}return Object.freeze(Object.defineProperty(c,Symbol.toStringTag,{value:"Module"}))}var i={exports:{}},C;function K(){return C||(C=1,function(c,r){ace.define("ace/theme/ambiance-css",["require","exports","module"],function(n,a,e){e.exports=`.ace-ambiance .ace_gutter {
...
`}),ace.define("ace/theme/ambiance",["require","exports","module","ace/theme/ambiance-css","ace/lib/dom"],function(n,a,e){a.isDark=!0,a.cssClass="ace-ambiance",a.cssText=n("./ambiance-css");var o=n("../lib/dom");o.importCssString(a.cssText,a.cssClass,!1)}),function(){ace.require(["ace/theme/ambiance"],function(n){c&&(c.exports=n)})}()}(i)),i.exports}var l=K();const k=m(l),h=t({__proto__:null,default:k},[l]);export{h as t};
