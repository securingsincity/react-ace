...
describe("Ace Component", () => {
  ...
  describe("General", () => {
    it("should render without problems with defaults properties", () => {
      const wrapper = mount(<AceEditor />, { attachTo: window.domNode });
    ...
    it("should get the ace library from the onBeforeLoad callback", () => {
      ...
      mount(<AceEditor onBeforeLoad={beforeLoadCallback} />, getMountOptions());
    ...
    it("should trigger the focus on mount", () => {
      ...
      mount(
        <AceEditor focus={true} onFocus={onFocusCallback} />,
        getMountOptions()
      );
    ...
    it("should set up the markers", () => {
      ...
      const wrapper = mount(<AceEditor markers={markers} />, getMountOptions());
    ...
    it("should add annotations and clear them", () => {
      ...
      const wrapper = mount(<AceEditor />, getMountOptions());
      const editor = wrapper.instance().editor;
  ...
  describe("Events", () => {
    ...
    it("should call the onSelectionChange method callback", done => {
      ...
      `;
      const wrapper = mount(<AceEditor value={value} />, getMountOptions());
  ...
  describe("ComponentDidUpdate", () => {
    ...
    it("should update the editorOptions on componentDidUpdate", () => {
      const wrapper = mount(<AceEditor minLines={1} />, getMountOptions());
    ...
    it("should update the mode on componentDidUpdate", () => {
      const wrapper = mount(<AceEditor mode="javascript" />, getMountOptions());
